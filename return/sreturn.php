...
<head>
	<title></title>
	<link rel="stylesheet" type="text/css" href="sreturn.css">
...
<body>
	<?php
    	...
    	include("../dbconnect/db.php");
	   	$query="select * from addproduct where invoice='$invoice' and name='$name'";
    ...
    ?>
    <form class="box" method="POST" action="done.php">
    	...
    	<p>Date of Purchase: <input type="date" value="<?php echo $data['date'];?>" readonly></p>
    	<p>Invoice No.: <input type="number" name="invoice" value="<?php echo $data['invoice'];?>" readonly>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Supplier Name: <input type="text" value="<?php echo $data['supplier'];?>" readonly>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Phone Number: <input type="text" value="<?php echo $data['phone'];?>" readonly></p>
    	<p>Price: <input type="number" id="pr" value="<?php echo $data['price']?>" onkeyup="sum()"readonly></p>
    	<p>Qty: <input type="number" id="q" value="<?php echo $data['qty']?>" onkeyup="sum()"readonly>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Discount: <input type="number" id="d" value="<?php echo $data['discount']?>" readonly>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Due Amount: <input type="number"
    	id="due" value="<?php echo $data['due']?>" readonly></p>
    ...
    <a href="return.php" class="aa">Return Back</a>
    </form>
    <?php 
	}
	else{
		echo "<script>alert('Record Not Found')</script>";
        ?><meta http-equiv="Refresh" content="0.4;http://localhost/summ/return/return.php"><?php
		}
    ?>
</body>
</html>
