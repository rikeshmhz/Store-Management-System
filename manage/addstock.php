...
<body>
    ...
    ?>
    <form class="box" method="POST" action="search.php">
    ...
    <a href="../manage/addnew.php"><button class="b2">Add New Product</button></a>
    ...
    <?php while($row=mysqli_fetch_array($result)){ ?>
    	<tr>
    		...
    		<td><a href="<?php echo "view.php?id=".$row['id']?>"><button><img src="../image/new.jpg">Add</button>
    </a></td>
    	</tr>
    <?php		
	}
